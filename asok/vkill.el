...
(evil-define-key 'normal vkill-keymap " " 'next-line)
(evil-define-key 'normal vkill-keymap "j" 'next-line)
(evil-define-key 'normal vkill-keymap "k" 'previous-line)
;(evil-define-key 'normal vkillkeyymap "\C-?" 'previous-line)
(evil-define-key 'normal vkill-keymap "?" 'vkill-help)
(evil-define-key 'normal vkill-keymap "d" 'vkill-mark-process) ; Dired compatibility
(evil-define-key 'normal vkill-keymap "m" 'vkill-mark-process)
(evil-define-key 'normal vkill-keymap "M" 'vkill-mark-all-processes)
(evil-define-key 'normal vkill-keymap "P" 'vkill-update-process-info)
;(evil-define-key 'normal vkillkeyymap "g" 'revert-buffer) ; Dired compatibility
(evil-define-key 'normal vkill-keymap "q" 'vkill-quit)
(evil-define-key 'normal vkill-keymap "u" 'vkill-unmark-process)
(evil-define-key 'normal vkill-keymap "U" 'vkill-unmark-all-processes)
(evil-define-key 'normal vkill-keymap "D" '(lambda () (interactive) (vkill-mark-process) (vkill-send-signal "KILL"))) ; Dired compatibility
(evil-define-key 'normal vkill-keymap "t" 'vkill-toggle-truncate-lines)
